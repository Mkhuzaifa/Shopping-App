...
class AppColors {
  ...
  static Color orange = Color(0xff262938);
  ...
  static Color MyButton = Colors.deepPurple;
  static Color Divider = Colors.white10;
  ...
  static const Color dividedColor =  Colors.grey;
